...
\begin{verbatim}[language=TypeScript, caption=Integratie van ng-file-upload]
...
\begin{verbatim}[language=TypeScript, caption=Integratie van ngx-dropzone]
...
\begin{verbatim}[language=TypeScript, caption=Integratie van Angular Material File Input]
...
\begin{verbatim}[language=TypeScript, caption=AWS SDK voor directe S3-integratie]
...
\begin{verbatim}[language=TypeScript, caption=Azure Storage Blob integratie]
...
\begin{verbatim}[language=TypeScript, caption=Abstracte cloudstorage service]
...
\begin{verbatim}[language=TypeScript, caption=Herbruikbare cloud uploader component]
@Component({
