...
\begin{tabular}{lcr}
\toprule
\textbf{Cloudopslagdienst} & \textbf{Integratie} & \textbf{Aanbevolen package} & \textbf{Beperkingen} \\
\midrule
...
\bottomrule
\end{tabular}
\caption[Vergelijking cloudintegraties]{Vergelijking van integratiemethoden voor cloudopslagdiensten.}
\label{tab:cloud-vergelijking}
\end{table}
